...
class InvertedPendulumProb : public casadi_mpc_template::Problem
{
  public:
    InvertedPendulumProb() : Problem(DynamicsType::ContinuesRK4, 2, 1, 60, 0.05)
    {
        ...
        set_input_lower_bound(Eigen::VectorXd::Constant(1, -2.0));
        set_input_upper_bound(Eigen::VectorXd::Constant(1, 2.0));
    }
...
{
    // Initialize ROS node
    ros::init(argc, argv, "inverted_pendulum_node");
    ros::NodeHandle nh;
